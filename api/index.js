...
function getProducts(request, response) {
  ...
  let data = []
  if (category_id > 0) {
    const sqlOpdracht = db.prepare('SSELECT products.id , products.name, genre.name AS genrename, products.description, products.price, verfilmd.name AS isverfilmd, schrijver.name AS schrijvername, code, uitgever.name AS uitgevername, bladzijdes FROM products JOIN genre ON products.genre_id = genre.id left outer JOIN schrijver ON products.schrijver_id = schrijver.id left outer JOIN verfilmd ON products.verfilmd_id = verfilmd.id left outer JOIN uitgever ON products.uitgever_id = uitgever.id ORDER BY products.name ASC SELECT products.id AS product_id, products.name, genre.name AS genrename, products.description, products.price, verfilmd.name AS isverfilmd, schrijver.name AS schrijvername, code, uitgever.name AS uitgevername, bladzijdes FROM products JOIN genre ON products.genre_id = genre.id left outer JOIN schrijver ON products.schrijver_id = schrijver.id left outer JOIN verfilmd ON products.verfilmd_id = verfilmd.id left outer JOIN uitgever ON products.uitgever_id = uitgever.id ORDER BY products.name ASCSELECT products.id AS product_id, products.name, genre.name AS genrename, products.description, products.price, verfilmd.name AS isverfilmd, schrijver.name AS schrijvername, code, uitgever.name AS uitgevername, bladzijdes FROM products JOIN genre ON products.genre_id = genre.id left outer JOIN schrijver ON products.schrijver_id = schrijver.id left outer JOIN verfilmd ON products.verfilmd_id = verfilmd.id left outer JOIN uitgever ON products.uitgever_id = uitgever.id ORDER BY products.name ASCSELECT products.id AS product_id, products.name, genre.name AS genrename, products.description, products.price, verfilmd.name AS isverfilmd, schrijver.name AS schrijvername, code, uitgever.name AS uitgevername, bladzijdes FROM products JOIN genre ON products.genre_id = genre.id left outer JOIN schrijver ON products.schrijver_id = schrijver.id left outer JOIN verfilmd ON products.verfilmd_id = verfilmd.id left outer JOIN uitgever ON products.uitgever_id = uitgever.id ORDER BY products.name ASCSELECT products.id AS product_id, products.name, genre.name AS genrename, products.description, products.price, verfilmd.name AS isverfilmd, schrijver.name AS schrijvername, code, uitgever.name AS uitgevername, bladzijdes FROM products JOIN genre ON products.genre_id = genre.id left outer JOIN schrijver ON products.schrijver_id = schrijver.id left outer JOIN verfilmd ON products.verfilmd_id = verfilmd.id left outer JOIN uitgever ON products.uitgever_id = uitgever.id ORDER BY products.name ASCSELECT products.id AS product_id, products.name, genre.name AS genrename, products.description, products.price, verfilmd.name AS isverfilmd, schrijver.name AS schrijvername, code, uitgever.name AS uitgevername, bladzijdes FROM products JOIN genre ON products.genre_id = genre.id left outer JOIN schrijver ON products.schrijver_id = schrijver.id left outer JOIN verfilmd ON products.verfilmd_id = verfilmd.id left outer JOIN uitgever ON products.uitgever_id = uitgever.id ORDER BY products.name ASCSELECT products.id AS product_id, products.name, genre.name AS genrename, products.description, products.price, verfilmd.name AS isverfilmd, schrijver.name AS schrijvername, code, uitgever.name AS uitgevername, bladzijdes FROM products JOIN genre ON products.genre_id = genre.id left outer JOIN schrijver ON products.schrijver_id = schrijver.id left outer JOIN verfilmd ON products.verfilmd_id = verfilmd.id left outer JOIN uitgever ON products.uitgever_id = uitgever.id ORDER BY products.name ASCSELECT products.id AS product_id, products.name, genre.name AS genrename, products.description, products.price, verfilmd.name AS isverfilmd, schrijver.name AS schrijvername, code, uitgever.name AS uitgevername, bladzijdes FROM products JOIN genre ON products.genre_id = genre.id left outer JOIN schrijver ON products.schrijver_id = schrijver.id left outer JOIN verfilmd ON products.verfilmd_id = verfilmd.id left outer JOIN uitgever ON products.uitgever_id = uitgever.id ORDER BY products.name WHERE category_id = ? ORDER BY products.name ASC')
    data = sqlOpdracht.all(category_id)
  } else {
     const sqlOpdracht = db.prepare ('SELECT products.id , products.name, genre.name AS genrename, products.description, products.price, verfilmd.name AS isverfilmd, schrijver.name AS schrijvername, code, uitgever.name AS uitgevername, bladzijdes FROM products JOIN genre ON products.genre_id = genre.id left outer JOIN schrijver ON products.schrijver_id = schrijver.id left outer JOIN verfilmd ON products.verfilmd_id = verfilmd.id left outer JOIN uitgever ON products.uitgever_id = uitgever.id ORDER BY products.name ASC')
